export const EN_TRANSLATIONS: Record<string, string> = {
  ...
  // ── Footer ──
  'footer.description':
    'Your one-stop shop for premium products. Quality meets affordability with fast delivery and excellent customer support.',
  'footer.quick_links': 'Quick Links',
  'footer.categories': 'Categories',
  'footer.contact_us': 'Contact Us',
  'footer.address': '123 Commerce St, Shop City',
  'footer.email': 'support@shopzone.com',
  'footer.phone': '+1 (555) 123-4567',
  'footer.hours': 'Mon - Fri: 9AM - 6PM',
  'footer.rights': 'ShopZone. All rights reserved.',
