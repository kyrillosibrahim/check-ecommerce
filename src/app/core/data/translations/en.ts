export const EN_TRANSLATIONS: Record<string, string> = {
  ...
  'nav.offers': 'Offers',
  'nav.watch': 'Watch',
  'details.direct_order': 'Direct Order',
  ...
  'reviews.reviews_heading': 'Reviews',
  'reviews.based_on': 'reviews',
  'reviews.based_on_pre': 'Based on',
  'reviews.verified': 'Verified purchase',
  'reviews.helpful': 'Helpful',
  'reviews.read_more': 'Show more',
  'reviews.read_less': 'Show less',
  'reviews.login_to_vote': 'Log in to vote',
  'reviews.write': 'Write your review',
  'reviews.your_rating': 'Your rating',
  'reviews.choose_stars': 'Please choose a star rating first',
  ...
  'details.price_comparison': 'Compare Our Prices With Other Sites',
  'details.comparison_product': 'Product',
  'details.comparison_site': 'Site',
  'details.comparison_price': 'Price',
  'details.comparison_buy': 'Buy Now',
  'details.our_price': 'Our Price',
  'details.tags': 'Tags:',
  ...
  'checkout.instapay_shipping_badge': '50% off shipping',
  'checkout.full_name_placeholder': 'Enter your full name',
